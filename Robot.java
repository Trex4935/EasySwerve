...
public class Robot extends TimedRobot {
   ...
   */
  // drive motors declared
  private WPI_TalonSRX FLdriveMotor;
  private WPI_TalonSRX FRdriveMotor;
  private WPI_TalonSRX BLdriveMotor;
  private WPI_TalonSRX BRdriveMotor;
  // angle motors declared
  private CANSparkMax FLangleMotor;
  private CANSparkMax FRangleMotor;
  private CANSparkMax BLangleMotor;
  private CANSparkMax BRangleMotor;
  // pid controllers declared
  ...
  public void robotInit() {
    ...
    // initalize drive motor
    FLdriveMotor = new WPI_TalonSRX(FLdriveID, MotorType.kBrushed);
    FRdriveMotor = new WPI_TalonSRX(FRdriveID, MotorType.kBrushed);
    BLdriveMotor = new WPI_TalonSRX(BLdriveID, MotorType.kBrushed);
    BRdriveMotor = new WPI_TalonSRX(BRdriveID, MotorType.kBrushed);
  ...
  public void teleopPeriodic() {
    ...
    FLdriveMotor.setInverted((drive_control.getLeftY()) / 4);
    FRdriveMotor.setInverted((drive_control.getLeftY()) / 4);
    ...
    while (drive_control.getRightTriggerAxis() > .05) {
      m_PIDController1.setReference(-2, CANSparkMax.ControlType.kPosition);
      m_PIDController2.setReference(-2, CANSparkMax.ControlType.kPosition);
      FLdriveMotor.setInverted((drive_control.getLeftY()));
      FRdriveMotor.setInverted((drive_control.getLeftY()));
    ...
    while (drive_control.getLeftBumper() == true) {
      ...
      FRdriveMotor.setInverted((drive_control.getRightX()) / 15);
      BRdriveMotor.set(drive_control.getRightX() / 15);
      BLdriveMotor.setInverted((drive_control.getRightX()) / 15);
    }
    /**
